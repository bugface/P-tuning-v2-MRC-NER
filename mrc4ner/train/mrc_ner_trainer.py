...
class BertLabeling(pl.LightningModule):
    def __init__(self, args: argparse.Namespace):
        ...
        if self.args.model_type == "bert":
        ...
        elif self.args.model_type == "megatron":
            self.model = MegatronQueryNER.from_pretrained(
                args.bert_config_dir, config=bert_config
            )
            ...
            raise RuntimeError(
                f"model type should be bert or megatron but {self.args.model_type}"
            )
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default="bert",
            help="bert or megatron or pbert or pmegatron",
        )
        parser.add_argument(
